        ...
        <form className="search-widget-form">
          <label className="one">
            ...
            <input
              ...
              placeholder="Defaults to 528 Kent St, Sydney, NSW, 2000"
              id="propertyAddress"
              required
              tabIndex={1}
            />
            <p className="smaller-font">
              * Must contain street, suburb, state & postcode with each
              separated by comma
            </p>
          </label>
          <PropertyTypeDropdown
            chosenPropertyTypes={props.searchParameters.propertyTypes}
            changePropertyTypes={(newPropertyTypes) => {
              props.changeSearchParameters({
                ...props.searchParameters,
          ...
          />
          <label className="two">
            Neighbours Search (max records) <br />
            <input
              className="below-label border"
              id="numberOfRecords"
              onChange={(e: ChangeEvent<HTMLInputElement>) => {
          ...
          <label className="three">
            Property Types Filter Max Records <br />
            <input
              className="below-label border"
              id="propertyTypeNumberOfRecords"
              onChange={(e: ChangeEvent<HTMLInputElement>) => {
                if (Number.isNaN(e.target.valueAsNumber)) {
                  props.changeSearchParameters({
                    ...props.searchParameters,
          ...
          <PropertyGroupDropdown
            chosenPropertyGroups={props.searchParameters.propertyGroups}
            changePropertyGroups={(newPropertyGroups) => {
              props.changeSearchParameters({
                ...props.searchParameters,
          ...
          <label className="four">
            Property Groups Filter Max Records <br />
            <input
              className="below-label border"
              id="propertyGroupNumberOfRecords"
              onChange={(e: ChangeEvent<HTMLInputElement>) => {
                if (Number.isNaN(e.target.valueAsNumber)) {
                  props.changeSearchParameters({
                    ...props.searchParameters,
          ...
          <ManagedDrop
            managed={props.searchParameters.managed}
            changedManaged={(isManaged) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                managed: isManaged,
              });
