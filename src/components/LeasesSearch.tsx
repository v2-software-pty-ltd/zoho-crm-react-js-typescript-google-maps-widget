    ...
    <>
      ...
      <form className="search-widget-form">
        <label className="eight">
          ...
          <br />
          <input
            className="minMaxSize border"
            id="landAreaMin"
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                landArea: {
                  min: e.target.valueAsNumber || -1,
                  max: props.searchParameters.landArea.max,
                },
              });
            }}
            placeholder="Min"
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                landArea: {
                  min: props.searchParameters.landArea.min,
                  max: e.target.valueAsNumber || -1,
                },
              });
            }}
            placeholder="Max"
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...
                buildArea: {
                  ...
                  max: props.searchParameters.buildArea.max || -1,
                },
              });
            }}
            placeholder="Min"
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                buildArea: {
                  min: props.searchParameters.buildArea.min,
                  max: e.target.valueAsNumber || -1,
                },
              });
            }}
        ...
        <label className="twelve">
          ...
          <DatePicker
            className="border"
            selected={props.searchParameters.leasedDate.min}
            ...
            onChange={(changeDate: Date) => {
              props.changeSearchParameters({
                ...
                leasedDate: {
                  ...
                  max: props.searchParameters.leasedDate.max,
                },
              });
            }}
          />
          <DatePicker
            className="border"
            selected={props.searchParameters.leasedDate.max}
            dateFormat="dd/MM/yyyy"
            placeholderText="Max"
            onChange={(changeDate: Date) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                leasedDate: {
                  min: props.searchParameters.leasedDate.min,
                  max: changeDate || undefined,
                },
              });
            }}
          />
        </label>
        <label className="thirteen">
          Review Date
          <br />
          <DatePicker
            className="border"
            selected={props.searchParameters.reviewDate.min}
            dateFormat="dd/MM/yyyy"
            placeholderText="Min"
            onChange={(changeDate: Date) => {
              props.changeSearchParameters({
                ...
                reviewDate: {
                  min: changeDate || undefined,
                  max: props.searchParameters.reviewDate.max,
                },
              });
            }}
          />
          <DatePicker
            className="border"
            selected={props.searchParameters.reviewDate.max}
            dateFormat="dd/MM/yyyy"
            placeholderText="Max"
            onChange={(changeDate: Date) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                reviewDate: {
                  min: props.searchParameters.reviewDate.min,
                  max: changeDate || undefined,
                },
              });
            }}
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...
                rentPerDollarMeter: {
                  min: e.target.valueAsNumber || -1,
                  max: props.searchParameters.rentPerDollarMeter.max,
                },
              });
            }}
            placeholder="Min"
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                rentPerDollarMeter: {
                  min: props.searchParameters.rentPerDollarMeter.min,
                  max: e.target.valueAsNumber || -1,
                },
              });
            }}
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...
                rentGross: {
                  min: e.target.valueAsNumber || -1,
                  max: props.searchParameters.rentGross.max,
                },
              });
            }}
            placeholder="Min"
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => {
              props.changeSearchParameters({
                ...props.searchParameters,
                rentGross: {
                  min: props.searchParameters.rentGross.min,
                  max: e.target.valueAsNumber || -1,
                },
              });
            }}
